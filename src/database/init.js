...
const CREATE_AUDIT_LOG_INDEX = `
  CREATE INDEX IF NOT EXISTS idx_audit_log_created_at ON audit_log(created_at DESC);
`;

module.exports = { CREATE_ROLES_TABLE, CREATE_USERS_TABLE, SEED_ROLES, SEED_OWNER, CREATE_OBSERVATIONS_TABLE, CREATE_OBSERVATION_REQUESTS_TABLE, ADD_PREFERENCES_COLUMNS, ADD_DELETED_AT_COLUMN, ADD_PROPOSED_COLUMNS, CREATE_AUDIT_LOG_TABLE, CREATE_AUDIT_LOG_INDEX };
